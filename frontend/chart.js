...
}(this, (function ()
{
	...
	class en
	{
		...
		register(t)
		{
			...
			{
				const s = x(Object.create(null), [i ? ue.get(i) :
				{}, ue.get(e), t.defaults]);
	...
	class _n
	{
		...
		getOptionScopes(t, e, i)
		{
			...
			e.forEach((e =>
			{
				t && (r.add(t), e.forEach((e => bn(r, t, e)))), e.forEach((t => bn(r, s, t))), e.forEach((t => bn(r, re[n] ||
				{}, t))), e.forEach((t => bn(r, ue, t))), e.forEach((t => bn(r, le, t)))
			}));
